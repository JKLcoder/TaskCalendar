...
- [ ] Confirm File > Data & Settings shows version, data location, storage type, current task count, and the portable data note.
- [ ] Confirm Open data location, Export backup, and Restore from JSON are manually spot-checked in the extracted portable app.
